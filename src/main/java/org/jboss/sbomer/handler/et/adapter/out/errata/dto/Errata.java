 ...
 */
package org.jboss.sbomer.handler.et.adapter.out.errata.dto;
...
import org.jboss.sbomer.handler.et.adapter.out.errata.dto.enums.ErrataStatus;
import org.jboss.sbomer.handler.et.adapter.out.errata.dto.enums.ErrataType;
...
public class Errata {
    ...
    public Optional<JsonNode> getNotesMapping() {
        ...
        try {
            ...
            return Optional.of(jsonObjectMapper.readTree(content.content.notes));
        } catch (Exception e) {
